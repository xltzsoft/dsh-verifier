...
export const CONFIG_DEFAULTS = {
  ...
  agent: {
    enabled: true,
    numCandidates: 3,
    /** parallel | sequential — only changes candidate request scheduling. */
    candidateScheduling: 'parallel',
    temperature: 1,
    models: [],
    majorityVoting: true,
    pivots: 2,
...
function mergeAgent(value = {}) {
  ...
  return {
    ...defaults,
    ...input,
    candidateScheduling: input.candidateScheduling === 'sequential' ? 'sequential' : 'parallel',
